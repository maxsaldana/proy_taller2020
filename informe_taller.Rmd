...
asce1 <- ascenso(log_ver, pars_ctrl)
...
Se puede apreciar, como era de esperarse, la similitud entre ambas estimaciones, generalmente difiriendo recién a partir del sexto valor después de la coma.


Probemos  ahora con un vector de valores iniciales ($x_0$) compuesto solo de ceros. Esto nos lleva a que la busqueda lineal falle reiteradamente, hasta llegar al máximo de iteraciones asignadas a la función que hace dicha búsqueda, 1000.
