...
De donde se denota que \alpha_n es la longitud de paso con la que se realizará la búsqueda, y pn es la dirección de búsqueda, determinada por el vector gradiente, de modo que cuando la norma del gradiente es mayor a 0 la función asciende, y una vez que la norma es igual a 0 ese ascenso se detiene.
